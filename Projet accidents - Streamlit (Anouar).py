...
if page == pages[4] :
    ...
    accidents = r"C:\Users\anoua\Downloads\df_accidents après pre-processing.csv"
    df_accidents = pd.read_csv(accidents, encoding="ISO-8859-1", header=0, index_col=0)

    st.dataframe(df_accidents.head())

    # Variables prédictives (features) et variable cible
    X = df_accidents[['mois','jour','lum','agg','int','atm','col','dep','annee','catr','circ','plan','surf','situ','place','catu','catv','obsm','choc','manv','jour_semaine','heure','age']]
    y = df_accidents['grav']
    ...
    model_RF_0 = r"C:\Users\anoua\Downloads\RF_0.joblib"
    model_RF_5 = r"C:\Users\anoua\Downloads\RF_5.joblib"
    model_RF_6 = r"C:\Users\anoua\Downloads\RF_6.joblib"
    model_RF_7 = r"C:\Users\anoua\Downloads\RF_7.joblib"
    model_RF_8 = r"C:\Users\anoua\Downloads\RF_8.joblib"

    model_DT_0 = r"C:\Users\anoua\Downloads\DT_0.joblib"
    model_DT_5 = r"C:\Users\anoua\Downloads\DT_5.joblib"
    model_DT_6 = r"C:\Users\anoua\Downloads\DT_6.joblib"
    model_DT_7 = r"C:\Users\anoua\Downloads\DT_7.joblib"
    model_DT_8 = r"C:\Users\anoua\Downloads\DT_8.joblib"
    ...
    def train_scores(model, metrique):
        ...
        if metrique == 'Accuracy':
            ...
            return recall_score(y_train, y_pred, average='binary')
        elif metrique == 'F1-score':
            return f1_score(y_train, y_pred, average='binary')
        elif metrique == 'Classification Report':
            return classification_report(y_train, y_pred)
        else:
            return "Invalid metric. Please choose from 'Accuracy', 'Recall', 'F1-score', or 'Classification Report'."
    ...
    profondeur_choisi = st.slider("Choisissez une profondeur pour le modèle", 0, 8, 5)
