...
def charger_datasets():
    ...
    df_caracteristiques=pd.read_csv(r"D:\1- VS Code -Data Scientest\Fil rouge\caracteristiques.csv", encoding = "ISO-8859-1",index_col=0)
    df_lieux = pd.read_csv(r"D:\1- VS Code -Data Scientest\Fil rouge\lieux.csv", encoding = "ISO-8859-1",index_col=0)
    df_usagers = pd.read_csv(r"D:\1- VS Code -Data Scientest\Fil rouge\usagers.csv", encoding = "ISO-8859-1",index_col=0)
    df_vehicules = pd.read_csv(r"D:\1- VS Code -Data Scientest\Fil rouge\vehicules.csv", encoding = "ISO-8859-1",index_col=0)
...
if page == pages[4] :
    ...
    with tab1 :
        ...
        accidents = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\accidents.csv"
    ...
    with tab5 :
        ...
        model_RF_0 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\RF_0.joblib"
        model_RF_5 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\RF_5.joblib"
        model_RF_6 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\RF_6.joblib"
        model_RF_7 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\RF_7.joblib"
        model_RF_8 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\RF_8.joblib"

        model_DT_0 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\DTC_0.joblib"
        model_DT_5 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\DTC_5.joblib"
        model_DT_6 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\DTC_6.joblib"
        model_DT_7 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\DTC_7.joblib"
        model_DT_8 = r"D:\1- VS Code -Data Scientest\Fil rouge\accidents-routes-cda\Données Anouard\DTC_8.joblib"
